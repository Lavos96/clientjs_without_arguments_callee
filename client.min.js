...
var swfobject = function() {
    ...
    function g(a, b, c, d) {
        ...
        if (g) {
            ...
            k.ie && k.win && 4 != g.readyState && (d = l.createElement("div"), c += "SWFObjectNew", d.setAttribute("id", c), g.parentNode.insertBefore(d, g), g.style.display = "none", function funkcja1() {
                4 == g.readyState ? g.parentNode.removeChild(g) : setTimeout(funkcja1, 10)
            }());
            h(a, b, c)
        }
    }
    ...
    function n(a) {
        if (k.ie && k.win && 4 != a.readyState) {
            ...
            (function funkcja2() {
                4 == a.readyState ? a.parentNode.removeChild(a) : setTimeout(funkcja2, 10)
            })()
    ...
    function u(a) {
        var b = m(a);
        b && "OBJECT" == b.nodeName && (k.ie && k.win ? (b.style.display = "none", function funkcja4() {
            if (4 == b.readyState) {
                var c = m(a);
                if (c) {
    ...
    (function() {
        k.w3 && (("undefined" != typeof l.readyState && "complete" == l.readyState ||
            "undefined" == typeof l.readyState && (l.getElementsByTagName("body")[0] || l.body)) && f(), y || ("undefined" != typeof l.addEventListener && l.addEventListener("DOMContentLoaded", f, !1), k.ie && k.win && (l.attachEvent("onreadystatechange", function funkcja5() {
            "complete" == l.readyState && (l.detachEvent("onreadystatechange", funkcja5), f())
        }), r == top && function funkcja6() {
            if (!y) {
                try {
                    l.documentElement.doScroll("left")
                } catch (a) {
                    setTimeout(funkcja6, 0);
                    return
                }
                f()
            }
        }()), k.wk && function funkcja7() {
            y || (/loaded|complete/.test(l.readyState) ? f() :
                setTimeout(funkcja7, 0))
        }(), e(f)))
    })();
    (function() {
